    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText   = QChar(0xA9)+QString(" %1-2018 ").arg(COPYRIGHT_YEAR) + QString(tr("The Functioncoin developers"));
    ...
    pixPaint.setFont(QFont(font, 10*fontFactor));
    pixPaint.drawText(newPixmap.width()-titleTextWidth-paddingRight, paddingTop+titleCopyrightVSpace, copyrightText2);
    pixPaint.drawText(newPixmap.width()-titleTextWidth-paddingRight, paddingTop+titleCopyrightVSpace+12, copyrightText);
