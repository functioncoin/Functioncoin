...
// Release
static const int64 PHASE1_MONEY = 1000000; // 45,000,000 (min 30D, max 171Y)
static const int64 PHASE2_BLOCKS = 45000; // 44D (min 0, max 64,948,224)
static const int64 PHASE3_MONEY = 2400000; // 10,000,000 + dust to even it out to 128M (min 5Y, max 40Y)
