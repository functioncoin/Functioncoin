...
uint256 hashGenesisBlock("0x00000adc3aa8b52692c4526aa62ae9dbad630f3924574867313c51a1a03344f6");
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Functioncoin Temporal Retargeting - exits "blackhole" in ~3hrs
    if (pindexLast->nHeight > nLifeWindow && count < nLifeWindow/4) {
        int min = nLifeWindow/4 - count;
        printf("Retarget: **** Functioncoin Temporal Retargeting **** %d/%d : factor = %d\n",
...
void ThreadScriptCheck() {
    RenameThread("Functioncoin-scriptch");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000adc3aa8b52692c4526aa62ae9dbad630f3924574867313c51a1a03344f6");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "The Functioncoin Released on May 6,2014 03:58:31";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot
               == uint256("0xb7aed1352fa2db4f79c200fc4140c8407d6319f7e19139c6d150312ae0c666fa"));
        block.print();
...
void static FunctioncoinMiner(CWallet *pwallet)
{
    printf("FunctioncoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Functioncoin-miner");
    ...
    try { loop {
        ...
        printf("Running FunctioncoinMiner with %"PRIszu" transactions in block (%u bytes)\n",
               pblock->vtx.size(),
    ...
    {
        printf("FunctioncoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nGenerateThreads; i++)
        minerThreads->create_thread(boost::bind(&FunctioncoinMiner, pwallet));
}
